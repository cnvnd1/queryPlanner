...
// @Failure 404 {object} httputil.HTTPError
// @Failure 500 {object} httputil.HTTPError
// @Router /accounts/test [get]
func getEsStatus(ctx *gin.Context) {

	cfg := elasticsearch7.Config{
		Addresses: []string{
			"http://c75111d1-temp-elasticsearc-1955-1266839488.ap-northeast-2.elb.amazonaws.com:80",
		},
	}
